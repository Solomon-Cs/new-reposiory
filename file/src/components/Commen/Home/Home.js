    ...
    <div>
      ...
      <div className="pl-48 pr-48 pb-16 pt-0">
        ...
        <Text className="text-justify text-xl">
          Task management system will provide users with a high-performing collaboration channel for
          Company employees and it enable to exchange necessary information
          related to everyday projects and tasks. This feature should be easy to
          use so that users don’t get confused and can use it comfortably. 
          Task tracking When a team is working on and planning a large number of
          tasks, it is essential to track the progress of each task. For
          convenience and comfort, excellent task management systems have a task
          tracking feature. This feature allows you to highlight each stage in
          which the task is, for example, in progress and completed. Also, We
          can add the ability to filter, categorize, create teams, etc., into
          task management tools. Prioritization board Sometimes it is
